...
${PERF_COMMAND} record -e arm_spe_0/load_filter=1,store_filter=0,jitter=${JITTER},period=${PERIOD},ts_enable=0/ -o data/${BASE}.${PERIOD}.load.perf.data -- ${BINARY}
${PERF_COMMAND} record -e arm_spe_0/load_filter=0,store_filter=1,jitter=${JITTER},period=${PERIOD},ts_enable=0/ -o data/${BASE}.${PERIOD}.store.perf.data -- ${BINARY}
